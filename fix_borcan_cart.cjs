...
// Yeni Sepet Sayfası (Total'i kendisi hesaplayan versiyon)
...
export default function CartPage() {
  // 'total' burada istenmiyor, çünkü CartProvider vermiyor olabilir.
  const { items, removeItem, updateQuantity, clearCart } = useCart();
  
  // Total'i biz burada kendimiz hesaplıyoruz
