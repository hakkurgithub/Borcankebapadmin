      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
          ...
          <form onSubmit={handleWhatsAppReservation} className="space-y-4">
            ...
            <textarea 
              placeholder="Özel istekleriniz (isteğe bağlı)..." 
              className="w-full p-3 border rounded-lg h-24 focus:ring-2 focus:ring-red-500 outline-none resize-none" 
              onChange={(e)=>setFormData({...formData, note: e.target.value})}
            ></textarea>
            <button 
              type="submit" 
              className="w-full bg-red-600 text-white py-4 rounded-lg font-bold hover:bg-red-700 transition-all transform active:scale-95 shadow-lg"
            >
