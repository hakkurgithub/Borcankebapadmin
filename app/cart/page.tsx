...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 pt-28 px-4 pb-12">
      <div className="max-w-md mx-auto bg-white p-6 rounded-[32px] shadow-2xl border border-gray-100">
        ...
        <div className="space-y-4">
          {cart.map((item, index) => (
            <div key={index} className="flex justify-between items-center bg-red-50 p-4 rounded-2xl border border-red-100">
              ...
              <button onClick={() => removeItem(index)} className="p-3 bg-white text-red-600 rounded-xl shadow-sm hover:bg-red-600 hover:text-white transition-all">
        ...
        }} className="w-full bg-green-600 text-white font-black py-5 rounded-2xl text-xl mt-6 shadow-lg hover:bg-green-700 transition-colors">
          WhatsApp'tan Gönder 🚀
        </button>
      </div>
    </div>
